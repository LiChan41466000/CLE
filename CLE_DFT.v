...
module CLE ( clk, reset, rom_q, rom_a, sram_q, sram_a, sram_d, sram_wen, 
  ...
  AOI21D1BWP16P90LVT U941 ( .A1(n443), .A2(n444), .B(reset), .ZN(N161) );
  INR3D1BWP16P90LVT U942 ( .A1(n438), .B1(n352), .B2(n294), .ZN(n444) );
  AOI222D1BWP16P90LVT U943 ( .A1(n374), .A2(n615), .B1(n612), .B2(n446), .C1(
        n282), .C2(cs[0]), .ZN(n443) );
  ND2D1BWP16P90LVT U944 ( .A1(n637), .A2(n403), .ZN(n446) );
  AOI21D1BWP16P90LVT U945 ( .A1(n448), .A2(n449), .B(reset), .ZN(N160) );
  NR3D1BWP16P90LVT U946 ( .A1(n450), .A2(n270), .A3(n352), .ZN(n449) );
  AOI222D1BWP16P90LVT U947 ( .A1(n374), .A2(first_scan), .B1(n613), .B2(n636), 
        .C1(n612), .C2(n637), .ZN(n448) );
  OAI22D1BWP16P90LVT U948 ( .A1(cs[2]), .A2(n616), .B1(cs[3]), .B2(n451), .ZN(
        n450) );
